...
class CommunicationsPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->discoverWidgets(in: app_path('Filament/Communications/Widgets'), for: 'App\Filament\Communications\Widgets')
            ->widgets([
                AccountWidget::class,
