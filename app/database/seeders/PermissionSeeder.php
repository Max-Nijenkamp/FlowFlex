...
class PermissionSeeder extends Seeder
{
    ...
    public const array PERMISSIONS = [
        ...
        'crm.segments.view-any',
        'crm.segments.create',
        'crm.segments.update',
        'crm.segments.delete',
        'crm.scheduling.view-any',
        'crm.scheduling.manage-types',
        'crm.scheduling.manage-own-availability',
        'crm.deal-rooms.view-any',
        'crm.deal-rooms.create',
        'crm.deal-rooms.update',
        'crm.deal-rooms.revoke',
        'crm.contracts.view-any',
        'crm.contracts.view',
        'crm.contracts.create',
        'crm.contracts.send',
        'crm.contracts.sign-off',
        'crm.contracts.terminate',
        'crm.email.connect-own',
        'crm.email.send',
        'crm.email.view-shared',
        'crm.sequences.view-any',
        'crm.sequences.create',
        'crm.sequences.update',
        'crm.sequences.enrol',
        'crm.sequences.manage-team',
        'crm.pricing.view-any',
        'crm.pricing.manage-products',
        'crm.pricing.manage-price-books',
        'crm.referrals.view-any',
        'crm.referrals.manage-programs',
        'crm.referrals.qualify',
        'crm.referrals.reward',
