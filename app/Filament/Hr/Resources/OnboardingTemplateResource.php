...
use App\Filament\Hr\Resources\OnboardingTemplateResource\RelationManagers\TemplateTasksRelationManager;
...
class OnboardingTemplateResource extends Resource
{
    ...
    {
        return auth()->user()?->can('hr.onboarding-templates.view') ?? false;
    }

    public static function canCreate(): bool
    {
        return auth()->user()?->can('hr.onboarding-templates.create') ?? false;
    }

    public static function canEdit($record): bool
    {
        return auth()->user()?->can('hr.onboarding-templates.edit') ?? false;
    }

    public static function canDelete($record): bool
    {
        return auth()->user()?->can('hr.onboarding-templates.delete') ?? false;
    }
    ...
    {
        return [
            TemplateTasksRelationManager::class,
        ];
    }
