...
- **Bug tracking workflow** — reported → triaged → in progress → resolved → verified
- **Definition of Done** — configurable checklist per team

## Works Alongside Project Planning

Both [[Project Planning]] and Agile & Sprint Management can be active simultaneously on the same project. Use Gantt for milestone planning, sprints for execution.
