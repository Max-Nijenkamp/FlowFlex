...
- **Team capacity view** — hours available vs allocated per team member this week
- **Role-based demand view** — how many hours of "Backend Developer" work do we have vs how many Backend Devs?
- **Time-off overlay** — show leave from [[Leave Management]] module on capacity calendar
