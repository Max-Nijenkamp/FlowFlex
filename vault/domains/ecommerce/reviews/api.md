...
Public submission/helpful-vote routes run on the **public/guest guard** with signed-URL validation of `review_token`, distinct from the authenticated Filament panel guard ([[../../../../build/security-audit-2026-06-11]] — HIGH).
