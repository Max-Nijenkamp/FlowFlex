...
| `ReconciliationPage` | #21 two-panel matcher custom page | [[../../../architecture/patterns/page-blueprints#Two-Panel Matcher]] — unreconciled txns (left) vs suggested journal lines (right) + bank-vs-GL balance strip, click to link; realtime none | `/finance/bank/{account}/reconcile`; row #21 per [[../../../decisions/decision-2026-07-03-two-panel-matcher-ui-row]] |
