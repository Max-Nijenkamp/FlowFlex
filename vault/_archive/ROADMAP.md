...
Milestone-based, no calendar dates (solo dev, aggressive 6–12 month target). A milestone is done when its **exit gate** passes — never start the next milestone's modules before the gate. Sequencing detail per module lives in [[_archive/BUILD-ORDER]].
...
- Build order within milestones: [[_archive/BUILD-ORDER]] (anchors first: `hr.profiles`, `finance.ledger`, `crm.contacts`)
...
- [[_archive/BUILD-ORDER]] · [[00-index/status-board]] · [[architecture/way-of-working]] · [[domains/_overview]]
